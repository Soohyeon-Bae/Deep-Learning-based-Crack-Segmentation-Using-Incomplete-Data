...
data = dict(
    ...
    val=dict(
        type='CustomDataset',
        data_root='dataset/exp1/val_128_only_crack',
    ...
    test=dict(
        type='CustomDataset',
        data_root='dataset/exp1/test_128_only_crack',
        pipeline=test_pipeline,
        split=None,
        img_dir='img',
        ann_dir='mask',
...
log_config = dict(interval=50, hooks=[dict(type='TextLoggerHook'),
                                      dict(type='WandbLoggerHook',
                                           init_kwargs=dict(project='crack_segmentation', name='inaccurate_kaggle_val128'))])
work_dir = './work_dirs/crack_segmentation/inaccurate_kaggle_val128'