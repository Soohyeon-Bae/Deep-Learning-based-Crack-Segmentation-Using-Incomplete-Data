...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='CustomDataset',
            data_root='dataset/re/kaggle_original',
            pipeline=train_pipeline,
            split=None,
            img_dir='img',
            ann_dir='mask',
    ...
    val=dict(
        type='CustomDataset',
        data_root='dataset/re/clean_val',
    ...
    test=dict(
        type='CustomDataset',
        data_root='dataset/re/clean_test',
        pipeline=test_pipeline,
        split=None,
        img_dir='img',
        ann_dir='mask',
...
log_config = dict(interval=50, hooks=[dict(type='TextLoggerHook'),
                                      dict(type='WandbLoggerHook',
                                           init_kwargs=dict(project='data_augmentation_x8_deeplabv3plus', name='baseline_1'))])
work_dir = './work_dirs/x8/baseline_1_2'