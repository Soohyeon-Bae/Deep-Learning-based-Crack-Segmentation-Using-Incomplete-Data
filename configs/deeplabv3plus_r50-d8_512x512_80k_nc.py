...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='CustomDataset',
            data_root='dataset/x8/kaggle_relavant_noisy_clean',
            pipeline=train_pipeline,
            split=None,
            img_dir='img',
            ann_dir='mask',
...
log_config = dict(interval=50, hooks=[dict(type='TextLoggerHook'),
                                      dict(type='WandbLoggerHook',
                                           init_kwargs=dict(project='data_augmentation_x8_deeplabv3plus', name='noisy_and_clean'))])
work_dir = './work_dirs/x8/noisy_clean'